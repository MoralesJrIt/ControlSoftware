 ...
 * @author Usuario
 */
public class caja_salidas extends javax.swing.JInternalFrame {
    ...
    public caja_salidas(Caja[] caja) {
        ...
        monto.setText(""+caja[0].valoractual());
        this.caja=caja[0];
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("RETIROS DE CAJA");
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addComponent(monto, javax.swing.GroupLayout.PREFERRED_SIZE, 239, javax.swing.GroupLayout.PREFERRED_SIZE)))))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
         URL url1=new URL(ControlSoftware.url + "usuario/login" + "?user=" + bd.valor("select user from usuario where cod_user=" + ControlSoftware.us) + "&password=" + password1.getText());
            ...
            Logger.getLogger(caja_salidas.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(caja_salidas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new caja_salidas(null).setVisible(true);
            }
        });
    }
