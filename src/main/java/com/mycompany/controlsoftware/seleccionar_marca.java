 ...
 * @author Usuario
 */
public class seleccionar_marca extends javax.swing.JInternalFrame {

    /**
     * Creates new form seleccionar_marca
     */
    BaseDeDatos bd = new BaseDeDatos();
    public seleccionar_marca() {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 2 && !evt.isConsumed()) {
                    evt.consume();
         nuevoproducto.marca.setText(cod.getText());
        nuevoproducto.descmarca.setText(descripcion.getText());
        dispose();
         }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(seleccionar_marca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new seleccionar_marca().setVisible(true);
            }
        });
    }
