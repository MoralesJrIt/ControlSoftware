    ...
    private void companyMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_companyMouseClicked
        ...
        if (evt.getClickCount() == 2 && !evt.isConsumed()) {
         ...
         URL url1=new URL(ControlSoftware.url + "usuario/obtener" + "?idusuario=" + ControlSoftware.us + "&cia=" + ControlSoftware.cia);
            ...
            URL url2 = new URL(ControlSoftware.url+"caja/cerrarcaja");
            ...
            String parametros = "id="+caja[0].id()+"&valorFinal=0";
        ...
        Caja objetoAEnviar = new Caja(0,ControlSoftware.us,"",null,new BigDecimal(0.00),new BigDecimal(0),new BigDecimal(0),1,1); // Reemplaza con tu instancia de objeto
