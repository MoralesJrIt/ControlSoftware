 ...
 * @author Usuario
 */
public class i_usuario extends javax.swing.JInternalFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (bd.versiesta("select user from usuario where user='" + usuario.getText()+"'")) {
...
//        }
        ...
        String codu = bd.doble("INSERT INTO `usuario`(`user`, `password`, `cod_role`, `cia`, `state`, `nombre`) VALUES ('" + usuario.getText() + "','" + hashPassword(pass) + "','2','" + ControlSoftware.cia + "','1','" + nombre.getText() + "')", "SELECT @@IDENTITY AS 'id'");
        for (int i = 0; i < jTable1.getRowCount(); i++) {
            if (("" + jTable1.getValueAt(i, 2)).equals("true")) {
                bd.EjecutarConsultas("INSERT INTO `role_usuario`(`roleid`, `usuarioid`, `cia`, `estado`) VALUES ('" + jTable1.getValueAt(i, 0) + "','" + codu + "','" + ControlSoftware.cia + "','1')");
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(i_usuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
