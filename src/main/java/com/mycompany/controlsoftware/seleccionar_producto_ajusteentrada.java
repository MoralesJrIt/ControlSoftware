 ...
 * @author Usuario
 */
public class seleccionar_producto_ajusteentrada extends javax.swing.JInternalFrame {
    ...
    public seleccionar_producto_ajusteentrada() {
...
//        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/back72.png")));
    ...
    private void ProductosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ProductosMouseClicked
        ...
        if (evt.getClickCount() == 2 && !evt.isConsumed()) {
            ...
            for (int i = 0; i < ajustedeentrada.detalle.getRowCount(); i++) {
                if (ajustedeentrada.detalle.getValueAt(i, 0).toString().equals(Productos.getValueAt(pick, 0).toString())) {
                    JOptionPane.showMessageDialog(null, "PRODUCTO YA AGREGADO, SELECCIONE OTRO");
                    return;
                }
            }
            ajustedeentrada.idprod.setText("" + Productos.getValueAt(pick, 0));
            ajustedeentrada.codprod.setText("" + Productos.getValueAt(pick, 1));
            ajustedeentrada.desprod.setText("" + Productos.getValueAt(pick, 2));
            ...
            ajustedeentrada.costo.setText("" + costoenletras);
            ajustedeentrada.p1.setText(Productos.getValueAt(pick, 14).toString());
            ajustedeentrada.p2.setText(Productos.getValueAt(pick, 16).toString());
            ajustedeentrada.p3.setText(Productos.getValueAt(pick, 18).toString());
            ajustedeentrada.existencia.setText("" + (Integer.parseInt(Productos.getValueAt(pick, 5).toString()) - Integer.parseInt(Productos.getValueAt(pick, 6).toString())));
            ajustedeentrada.costonumeros = Productos.getValueAt(pick, 8).toString();
            ajustedeentrada.pventa.setText(Productos.getValueAt(pick, 14).toString());
            dispose();
            ajustedeentrada.cantidad.requestFocus();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(seleccionar_producto_ajusteentrada.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new seleccionar_producto_ajusteentrada().setVisible(true);
            }
        });
    }
