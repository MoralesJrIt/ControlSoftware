 ...
 * @author Usuario
 */
public class seleccionar_producto5 extends javax.swing.JInternalFrame {
...
//        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/back72.png")));
    ...
    private void ProductosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ProductosMouseClicked
        ...
        if (evt.getClickCount() == 2 && !evt.isConsumed()) {
            ...
            for (int i = 0; i < modificar_cotizacion.detalle.getRowCount(); i++) {
                if (modificar_cotizacion.detalle.getValueAt(i, 0).toString().equals(Productos.getValueAt(Productos.getSelectedRow(), 0).toString())) {
                    JOptionPane.showMessageDialog(null, "PRODUCTO YA AGREGADO, SELECCIONE OTRO");
                    return;
                }
            }
            modificar_cotizacion.idprod.setText("" + Productos.getValueAt(Productos.getSelectedRow(), 0));
            modificar_cotizacion.codprod.setText("" + Productos.getValueAt(Productos.getSelectedRow(), 1));
            modificar_cotizacion.desprod.setText("" + Productos.getValueAt(Productos.getSelectedRow(), 2));
            ...
            modificar_cotizacion.costo.setText("" + costoenletras);
            modificar_cotizacion.p1.setText(Productos.getValueAt(Productos.getSelectedRow(), 14).toString());
            modificar_cotizacion.p2.setText(Productos.getValueAt(Productos.getSelectedRow(), 16).toString());
            modificar_cotizacion.p3.setText(Productos.getValueAt(Productos.getSelectedRow(), 18).toString());
            modificar_cotizacion.existencia.setText(""+(Integer.parseInt(Productos.getValueAt(Productos.getSelectedRow(), 5).toString())-Integer.parseInt(Productos.getValueAt(Productos.getSelectedRow(), 6).toString())));
            modificar_cotizacion.costonumeros = Productos.getValueAt(Productos.getSelectedRow(), 8).toString();
            modificar_cotizacion.pventa.setText(Productos.getValueAt(Productos.getSelectedRow(), 14).toString());
            dispose();
            modificar_cotizacion.cantidad.requestFocus();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(seleccionar_producto5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new seleccionar_producto5().setVisible(true);
            }
        });
    }
