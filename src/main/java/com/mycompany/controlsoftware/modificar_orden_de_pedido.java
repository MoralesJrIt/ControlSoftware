 ...
 * @author Usuario
 */
public class modificar_orden_de_pedido extends javax.swing.JInternalFrame {
    ...
    public modificar_orden_de_pedido(String op) {
        ...
        codcliente.setText("" + bd.valor("select idcliente from orden_de_pedido where idorden=" + op + " and cia=" + ControlSoftware.cia));
        orden_pedido.setText(""+ bd.valor("select numero_orden from orden_de_pedido where idorden=" + op + " and cia=" + ControlSoftware.cia));
        codcliente.setText("" + bd.valor("select idcliente from orden_de_pedido where idorden=" + op + " and cia=" + ControlSoftware.cia));
        descliente.setText("" + bd.valor("select nombre from clientes where idcliente=" + codcliente.getText() + " and cia=" + ControlSoftware.cia));
        try {
            Date date = new SimpleDateFormat("yyyy-MM-dd").parse(bd.valor("select fechaorden from orden_de_pedido where idorden=" + op + " and cia=" + ControlSoftware.cia));
            fecha.setDate(date);
        } catch (Exception e) {
        ...
        bd.seleccionarItemPorId(vend, bd.valor("select idvendedor from orden_de_pedido where idorden=" + op + " and cia=" + ControlSoftware.cia));
        bd.LlenarTabla("select d.idproducto as CODIGO, p.codigo AS CODLETRAS, p.descripcion AS DESCRIPCION, d.cantidad AS CANTIDAD, d.costo AS PRECIOCOMPRA, d.preciovendido AS PRECIOVENTA, d.total AS TOTAL, d.observacion AS OBSERVACION from detalle_orden_de_pedido d inner join producto p on d.idproducto=p.idproducto where d.id_orden_de_pedido=" + op, detalle);
        obsfact.setText("" + bd.valor("select observacion from orden_de_pedido where idorden=" + op + " and cia=" + ControlSoftware.cia));
        if (bd.valor("select tipo from orden_de_pedido where idorden=" + op + " and cia=" + ControlSoftware.cia).equals("1")) {
            original.setSelected(true);
        }
        if (bd.valor("select condicionpago from orden_de_pedido where idorden=" + op + " and cia=" + ControlSoftware.cia).equals("1")) {
    ...
    private void initComponents() {
        ...
        jLabel10.setText("EDITAR ORDEN DE PEDIDO");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        seleccionarcliente3 l1 = new seleccionarcliente3();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (fecha.getDate() == null) {
            ...
            int opc = 0;
            opc = JOptionPane.showConfirmDialog(null, "Desea guardar el pedido con el siguiente numero: " + orden_pedido.getText() + "?");
            if (opc == 0) {
                Item ve = (Item) vend.getSelectedItem();

                //actualizo pedido general
                bd.EjecutarConsultas("UPDATE `orden_de_pedido` SET `tipo`='" + l + "',`idcliente`='" + codcliente.getText() + "',`idvendedor`='" + ve.getId() + "',`subtotal`='" + st + "',`isv`='" + im + "',`total`='" + t + "',`fechaorden`='" + Date_Format.format(fecha.getDate()) + "',`idusuario`='" + ControlSoftware.us + "',`observacion`='" + obsfact.getText() + "',`condicionpago`='" + m + "' WHERE idorden=" + opg + " and cia=" + ControlSoftware.cia);
                System.out.println("1");
                //desreservo para eliminar todo de ese pedido
                String producto_a_desreservar[] = bd.Llenar("select idproducto from detalle_orden_de_pedido where id_orden_de_pedido=" + opg + " and cia=" + ControlSoftware.cia, "idproducto");
                for (int i = 0; i < producto_a_desreservar.length; i++) {
                    Double qty = Double.parseDouble(bd.valor("select cantidad from detalle_orden_de_pedido where id_orden_de_pedido=" + opg + " and idproducto=" + producto_a_desreservar[i] + " and cia=" + ControlSoftware.cia));
                    bd.EjecutarConsultas("update producto set reserva=reserva-" + qty + " where idproducto=" + producto_a_desreservar[i] + " and cia=" + ControlSoftware.cia);
                }
                 System.out.println("2");
                //elimino todo
                bd.EjecutarConsultas("delete from detalle_orden_de_pedido where id_orden_de_pedido=" + opg + " and cia=" + ControlSoftware.cia);
                 System.out.println("3");
                //reinserto
                for (int i = 0; i < detalle.getRowCount(); i++) {
                    String v = bd.valor("select precio1 from producto where idproducto=" + detalle.getValueAt(i, 0));
                    bd.EjecutarConsultas("INSERT INTO `detalle_orden_de_pedido`(`id_orden_de_pedido`, `idproducto`, `cantidad`, `preciounitario`, `preciovendido`, `costo`, `total`, `fecha_detalle`, `idusuario`, `observacion`, `estado`, `cia`) VALUES ('" + opg + "','" + detalle.getValueAt(i, 0) + "','" + detalle.getValueAt(i, 3) + "','" + v + "','" + detalle.getValueAt(i, 5) + "','" + detalle.getValueAt(i, 4) + "','" + detalle.getValueAt(i, 6) + "','" + date.format(formatter) + "','" + ControlSoftware.us + "','" + detalle.getValueAt(i, 7) + "','1','" + ControlSoftware.cia + "')");
                    bd.EjecutarConsultas("update producto set reserva=reserva+" + detalle.getValueAt(i, 3) + " where idproducto=" + detalle.getValueAt(i, 0));
                }
                ...
                try {
                    if (l == 0) {
                        try {
                            ...
                            String path = "/orden_de_pedido_proforma.jasper";
                            InputStream inputStream = getClass().getResourceAsStream(path);
                            JasperReport jasperReport = (JasperReport) JRLoader.loadObject(inputStream);
                            Map<String, Object> parametros = new HashMap<>();
                            parametros.put("factura", opg);
                        ...
                        try {
                            ...
                            Connection conn = con.getConexion();
                            // Cargar el reporte desde el archivo .jasper
                            String path = "/orden_de_pedido_original.jasper";
                            InputStream inputStream = getClass().getResourceAsStream(path);
                            JasperReport jasperReport = (JasperReport) JRLoader.loadObject(inputStream);
                            Map<String, Object> parametros = new HashMap<>();
                            parametros.put("factura", opg);
    ...
    private void aggActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aggActionPerformed
        ...
        seleccionar_producto3 l1 = new seleccionar_producto3();
        Dimension internalFrameSize = l1.getSize();
        Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
        l1.setLocation((screenSize.width - internalFrameSize.width) / 2,
                (screenSize.height - internalFrameSize.height) / 2);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        if (pv < pc) {
            Ingreso_de_credenciales dialog = new Ingreso_de_credenciales("93");
            dialog.setModal(true);
            dialog.setVisible(true);  // AQUI DEBE ESPERAR A QUE INGRESE LOS DATOS PARA HACER LA SIGUIENTE CONDICION
            if (dialog.paso == false) {
                return;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(modificar_orden_de_pedido.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new modificar_orden_de_pedido("").setVisible(true);
            }
        });
    }
