 ...
 * @author Usuario
 */
public class seleccionarcliente_recibo extends javax.swing.JInternalFrame {
    ...
    public seleccionarcliente_recibo() {
    ...
    private void ProductosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ProductosMouseClicked
        ...
        if (evt.getClickCount() == 2 && !evt.isConsumed()) {
            ...
            recibo.codcliente.setText(u);
            recibo.descliente.setText(v);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(seleccionarcliente_recibo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new seleccionarcliente_recibo().setVisible(true);
            }
        });
    }
