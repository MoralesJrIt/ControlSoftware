 ...
 * @author Usuario
 */
public class modificar_cotizacion extends javax.swing.JInternalFrame {
    ...
    public modificar_cotizacion(String op) {
        ...
        orden_pedido.setText("" + bd.valor("select numero_cotizacion from cotizaciones where id=" + op + " and cia=" + ControlSoftware.cia));

        codcliente.setText("" + bd.valor("select clienteid from cotizaciones where id=" + op + " and cia=" + ControlSoftware.cia));
        descliente.setText("" + bd.valor("select nombre from clientes where idcliente=" + codcliente.getText() + " and cia=" + ControlSoftware.cia));
        try {
            Date date = new SimpleDateFormat("yyyy-MM-dd").parse(bd.valor("select fechaorden from cotizaciones where id=" + op + " and cia=" + ControlSoftware.cia));
            fecha.setDate(date);
        } catch (Exception e) {
        ...
        bd.seleccionarItemPorId(vend, bd.valor("select vendedorid from cotizaciones where id=" + op + " and cia=" + ControlSoftware.cia));
        bd.LlenarTabla("select d.productoid as CODIGO, p.codigo AS CODLETRAS, p.descripcion AS DESCRIPCION, d.cantidad AS CANTIDAD, d.costo AS PRECIOCOMPRA, d.preciocotizado AS PRECIOCOTIZADO, d.total AS TOTAL, d.observacion AS OBSERVACION from DETALLE_COTIZACION d inner join producto p on d.PRODUCTOID=p.idproducto where d.COTIZACIONID=" + op + " AND d.CIA=" + ControlSoftware.cia, detalle);
        obsfact.setText("" + bd.valor("select observacion from cotizaciones where id=" + op + " and cia=" + ControlSoftware.cia));
        if (bd.valor("select tipo from cotizaciones where id=" + op + " and cia=" + ControlSoftware.cia).equals("1")) {
            original.setSelected(true);
        }
        if (bd.valor("select condicionpago from cotizaciones where id=" + op + " and cia=" + ControlSoftware.cia).equals("1")) {
    ...
    private void initComponents() {
        ...
        jLabel10.setText("EDITAR COTIZACION");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        seleccionarcliente5 l1 = new seleccionarcliente5();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (fecha.getDate() == null) {
            ...
            if (opc == 0) {
                ...
                bd.EjecutarConsultas("UPDATE `cotizaciones` SET `tipo`='" + l + "',`clienteid`='" + codcliente.getText() + "',`vendedorid`='" + ve.getId() + "',`subtotal`='" + st + "',`isv`='" + im + "',`total`='" + t + "',`fechaorden`='" + Date_Format.format(fecha.getDate()) + "',`usuarioid`='" + ControlSoftware.us + "',`observacion`='" + obsfact.getText() + "',`condicionpago`='" + m + "' WHERE id=" + opg + " and cia=" + ControlSoftware.cia);

                //elimino todo
                bd.EjecutarConsultas("delete from detalle_cotizacion where cotizacionid=" + opg + " and cia=" + ControlSoftware.cia);

                //reinserto
                for (int i = 0; i < detalle.getRowCount(); i++) {
                    String v = bd.valor("select precio1 from producto where idproducto=" + detalle.getValueAt(i, 0));
                    bd.EjecutarConsultas("INSERT INTO `detalle_cotizacion`(`cotizacionid`, `productoid`, `cantidad`, `preciounitario`, `preciocotizado`, `costo`, `total`, `fecha_detalle`, `usuarioid`, `observacion`, `estado`, `cia`) VALUES ('" + opg + "','" + detalle.getValueAt(i, 0) + "','" + detalle.getValueAt(i, 3) + "','" + v + "','" + detalle.getValueAt(i, 5) + "','" + detalle.getValueAt(i, 4) + "','" + detalle.getValueAt(i, 6) + "','" + date.format(formatter) + "','" + ControlSoftware.us + "','" + detalle.getValueAt(i, 7) + "','1','" + ControlSoftware.cia + "')");
                }
                dispose();
    ...
    private void aggActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aggActionPerformed
        ...
        seleccionar_producto5 l1 = new seleccionar_producto5();
        Dimension internalFrameSize = l1.getSize();
        Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
        l1.setLocation((screenSize.width - internalFrameSize.width) / 2,
                (screenSize.height - internalFrameSize.height) / 2);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(modificar_cotizacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new modificar_cotizacion("").setVisible(true);
            }
        });
    }
