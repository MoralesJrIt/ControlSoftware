 ...
 * @author Usuario
 */
public class seleccionar_producto extends javax.swing.JInternalFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        nuevoproducto l = new nuevoproducto(2);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (Productos.getSelectedRowCount() == 0) {
         ...
         modificarproducto l = new modificarproducto(Integer.parseInt(""+Productos.getValueAt(Productos.getSelectedRow(), 0)), 2);
        Dimension internalFrameSize = l.getSize();
        Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
        l.setLocation((screenSize.width - internalFrameSize.width) / 2,
                (screenSize.height - internalFrameSize.height) / 2);
    ...
    private void ProductosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ProductosMouseClicked
        ...
        if (evt.getClickCount() == 2 && !evt.isConsumed()) {
            evt.consume();
            for (int i = 0; i < OrdenCompra.detalles.getRowCount(); i++) {
                if (OrdenCompra.detalles.getValueAt(i, 0).toString().equals(Productos.getValueAt(pick, 0).toString())) {
                    JOptionPane.showMessageDialog(null, "PRODUCTO YA AGREGADO, SELECCIONE OTRO");
                    return;
                }
            }
            OrdenCompra.idprod.setText(Productos.getValueAt(pick, 0).toString());
            OrdenCompra.codprod.setText(Productos.getValueAt(pick, 1).toString());
            OrdenCompra.desprod.setText(Productos.getValueAt(pick, 2).toString());
            OrdenCompra.costofinaldolar.setText(Productos.getValueAt(pick, 12).toString());
            OrdenCompra.costofinallempiras.setText(Productos.getValueAt(pick, 8).toString());
            OrdenCompra.u1.setText(Productos.getValueAt(pick, 13).toString());
            OrdenCompra.p1.setText(Productos.getValueAt(pick, 14).toString());
            OrdenCompra.u2.setText(Productos.getValueAt(pick, 15).toString());
            OrdenCompra.p2.setText(Productos.getValueAt(pick, 16).toString());
            OrdenCompra.u3.setText(Productos.getValueAt(pick, 17).toString());
            OrdenCompra.p3.setText(Productos.getValueAt(pick, 18).toString());
            OrdenCompra.u4.setText(Productos.getValueAt(pick, 19).toString());
            OrdenCompra.p4.setText(Productos.getValueAt(pick, 20).toString());
            OrdenCompra.u5.setText(Productos.getValueAt(pick, 21).toString());
            OrdenCompra.p5.setText(Productos.getValueAt(pick, 22).toString());
            OrdenCompra.agregar.setEnabled(true);
            ...
            OrdenCompra.cl = Double.parseDouble(costoenletras);
            OrdenCompra.qty = Double.parseDouble(Productos.getValueAt(pick, 5).toString());
            dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(seleccionar_producto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new seleccionar_producto().setVisible(true);
            }
        });
    }
