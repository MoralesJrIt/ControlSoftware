 ...
 * @author Usuario
 */
public class ingresar_orden_de_pedido extends javax.swing.JInternalFrame {
    ...
    public ingresar_orden_de_pedido(String op) {
        ...
        if (!op.equals("0")) {
            ...
            codcliente.setText("" + bd.valor("select clienteid from cotizaciones where id=" + pedido + " and cia=" + ControlSoftware.cia));
            descliente.setText("" + bd.valor("select nombre from clientes where idcliente=" + codcliente.getText() + " and cia=" + ControlSoftware.cia));
            try {
                Date date = new SimpleDateFormat("yyyy-MM-dd").parse(bd.valor("select fechaorden from cotizaciones where id=" + pedido + " and cia=" + ControlSoftware.cia));
                fecha.setDate(date);
            } catch (Exception e) {
                System.out.println(e);
            }
            bd.seleccionarItemPorId(vend, bd.valor("select vendedorid from cotizaciones where id=" + pedido + " and cia=" + ControlSoftware.cia));
            bd.LlenarTabla("select d.productoid as CODIGO, p.codigo AS CODLETRAS, p.descripcion AS DESCRIPCION, d.cantidad AS CANTIDAD, d.costo AS PRECIOCOMPRA, d.preciocotizado AS PRECIOVENTA, d.total AS TOTAL, d.observacion AS OBSERVACION from detalle_cotizacion d inner join producto p on d.productoid=p.idproducto where d.cotizacionid=" + pedido + " and d.cia=" + ControlSoftware.cia, detalle);
            obsfact.setText("" + bd.valor("select observacion from cotizaciones where id=" + pedido + " and cia=" + ControlSoftware.cia));
            if (bd.valor("select tipo from cotizaciones where id=" + pedido + " and cia=" + ControlSoftware.cia).equals("1")) {
                original.setSelected(true);
            }
            if (bd.valor("select condicionpago from cotizaciones where id=" + pedido + " and cia=" + ControlSoftware.cia).equals("1")) {
    ...
    private void initComponents() {
        ...
        jLabel10.setText("INGRESO DE ORDEN DE PEDIDO");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        seleccionarcliente2 l = new seleccionarcliente2();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (fecha.getDate() == null) {
            ...
            if (opc == 0) {
                ...
                String cf = bd.doble("INSERT INTO `orden_de_pedido`(`numero_orden`, `tipo`, `cia`, `idcliente`, `idvendedor`, `subtotal`, `isv`, `total`, `fechaorden`, `fechaingreso`, `idusuario`, `observacion`, `condicionpago`, `estado`, `cotid`) VALUES ('" + orden_pedido.getText() + "','" + l + "','" + ControlSoftware.cia + "','" + codcliente.getText() + "','" + ve.getId() + "','" + st + "','" + im + "','" + t + "','" + Date_Format.format(fecha.getDate()) + "','" + LocalDateTime.now() + "','" + ControlSoftware.us + "','" + obsfact.getText() + "','" + m + "','1','"+pedido+"')", "SELECT @@IDENTITY AS 'id'");
                for (int i = 0; i < detalle.getRowCount(); i++) {
                    String v = bd.valor("select precio1 from producto where idproducto=" + detalle.getValueAt(i, 0));
                    bd.EjecutarConsultas("INSERT INTO `detalle_orden_de_pedido`(`id_orden_de_pedido`, `idproducto`, `cantidad`, `preciounitario`, `preciovendido`, `costo`, `total`, `fecha_detalle`, `idusuario`, `observacion`, `estado`, `cia`) VALUES ('" + cf + "','" + detalle.getValueAt(i, 0) + "','" + detalle.getValueAt(i, 3) + "','" + v + "','" + detalle.getValueAt(i, 5) + "','" + detalle.getValueAt(i, 4) + "','" + detalle.getValueAt(i, 6) + "','" + date.format(formatter) + "','" + ControlSoftware.us + "','" + detalle.getValueAt(i, 7) + "','1','" + ControlSoftware.cia + "')");
                ...
                l1.show();
                if (!pedido.equals("0")) {
                    bd.EjecutarConsultas("update cotizaciones set estado=2 where id=" + pedido);
                }
                try {
                    if (l == 0) {
                        try {
    ...
    private void aggActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aggActionPerformed
        // TODO add your handling code here:
        seleccionar_producto2 l = new seleccionar_producto2();
        Dimension internalFrameSize = l.getSize();
        Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
        l.setLocation((screenSize.width - internalFrameSize.width) / 2,
                (screenSize.height - internalFrameSize.height) / 2);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ingresar_orden_de_pedido.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ingresar_orden_de_pedido("0").setVisible(true);
            }
        });
    }
