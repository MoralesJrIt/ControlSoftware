...
public class modificarproducto extends javax.swing.JInternalFrame {
    ...
    public modificarproducto(int se, int cambio) {
        ...
        temp = se;
        y = cambio;
        codprod.setText("" + bd.valor("select codigo from producto where idproducto=" + temp));
        descripcion.setText("" + bd.valor("select descripcion from producto where idproducto=" + temp));
        codcat.setText("" + bd.valor("select idcategoria from producto where idproducto=" + temp));
        descat.setText("" + bd.valor("select categoria from categoria where codcategoria=" + codcat.getText()));
        marca.setText("" + bd.valor("select marca from producto where idproducto=" + temp));
        descmarca.setText("" + bd.valor("select marca from marca where idmarca=" + marca.getText()));
        codsub.setText("" + bd.valor("select idsubcategoria from producto where idproducto=" + temp));
        dessub.setText("" + bd.valor("select subcategoria from subcategoria where codsubcategoria=" + codsub.getText()));
        codprov.setText("" + bd.valor("select idproveedor from producto where idproducto=" + temp));
        desprov.setText("" + bd.valor("select proveedor from proveedor where idproveedor=" + codprov.getText()));
        costofinallempiras.setText("" + bd.valor("select preciocompra from producto where idproducto=" + temp));
        factor.setText("" + bd.valor("select factor from producto where idproducto=" + temp));
        costofinaldolar.setText("" + bd.valor("select preciocompradolares from producto where idproducto=" + temp));
        arancel.setText("" + bd.valor("select arancel from producto where idproducto=" + temp));
        
        u1.setText("" + bd.valor("select utilidad1 from producto where idproducto=" + temp));
        p1.setText("" + bd.valor("select precio1 from producto where idproducto=" + temp));
        u2.setText("" + bd.valor("select utilidad2 from producto where idproducto=" + temp));
        p2.setText("" + bd.valor("select precio2 from producto where idproducto=" + temp));
        u3.setText("" + bd.valor("select utilidad3 from producto where idproducto=" + temp));
        p3.setText("" + bd.valor("select precio3 from producto where idproducto=" + temp));
        u4.setText("" + bd.valor("select utilidad4 from producto where idproducto=" + temp));
        p4.setText("" + bd.valor("select precio4 from producto where idproducto=" + temp));
        u5.setText("" + bd.valor("select utilidad5 from producto where idproducto=" + temp));
        p5.setText("" + bd.valor("select precio5 from producto where idproducto=" + temp));
        observacion.setText(bd.valor("select observacion from producto where idproducto=" + temp));
        ...
        bd.seleccionarItemPorId(ubicacion, bd.valor("select ubicación from producto where idproducto=" + temp + " and cia=" + ControlSoftware.cia));
        bd.seleccionarItemPorId(unidad, bd.valor("select unidad from producto where idproducto=" + temp + " and cia=" + ControlSoftware.cia));

        inactivo.setSelected(true);
        if (bd.valor("select estado from producto where idproducto=" + temp).equals("1")) {
    ...
    private void initComponents() {
        ...
        jPanel7.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "OBSERVACION", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("SansSerif", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N

        jPanel6.setBackground(new java.awt.Color(195, 180, 225));
        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "ESTADO DEL PRODUCTO", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("SansSerif", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        inactivo.setBackground(new java.awt.Color(195, 180, 225));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            ...
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addComponent(descat, javax.swing.GroupLayout.PREFERRED_SIZE, 214, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                    ...
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(dessub, javax.swing.GroupLayout.PREFERRED_SIZE, 214, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                    .addComponent(marca, javax.swing.GroupLayout.PREFERRED_SIZE, 58, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(descmarca, javax.swing.GroupLayout.PREFERRED_SIZE, 214, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        ...
                                        .addComponent(costoinicialdolar, javax.swing.GroupLayout.DEFAULT_SIZE, 155, Short.MAX_VALUE)
                                        .addComponent(costofinaldolar))
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(costoiniciallempiras, javax.swing.GroupLayout.DEFAULT_SIZE, 133, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        seleccionar_categoria1 l = new seleccionar_categoria1();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        seleccionar_subcategoria1 l = new seleccionar_subcategoria1(codcat.getText());
        Dimension internalFrameSize = l.getSize();
        Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
        l.setLocation((screenSize.width - internalFrameSize.width) / 2,
                (screenSize.height - internalFrameSize.height) / 2);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        seleccionar_proveedor1 l = new seleccionar_proveedor1();
        Dimension internalFrameSize = l.getSize();
        Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
        l.setLocation((screenSize.width - internalFrameSize.width) / 2,
                (screenSize.height - internalFrameSize.height) / 2);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try {
            ...
            bd.EjecutarConsultas("UPDATE `producto` SET `codigo`='" + codprod.getText() + "',`descripcion`='" + descripcion.getText() + "',`unidad`='" + un.getId() + "',`preciocompra`='" + costofinallempiras.getText() + "',`idproveedor`='" + codprov.getText() + "',`factor`='" + factor.getText() + "',`arancel`='" + arancel.getText() + "',`preciocompradolares`='" + costofinaldolar.getText() + "',`utilidad1`='" + u1.getText() + "',`precio1`='" + p1.getText() + "',`utilidad2`='" + u2.getText() + "',`precio2`='" + p2.getText() + "',`utilidad3`='" + u3.getText() + "',`precio3`='" + p3.getText() + "',`utilidad4`='" + u4.getText() + "',`precio4`='" + p4.getText() + "',`utilidad5`='" + u5.getText() + "',`precio5`='" + p5.getText() + "',`costoenletras`='" + costoenletras + "',`marca`='" + marca.getText() + "',`idcategoria`='" + codcat.getText() + "',`idsubcategoria`='" + codsub.getText() + "',`observacion`='" + observacion.getText() + "',`ultimamodificacion`='" + date.format(formatter) + "',`idusuarioingresa`='" + 1 + "',`ubicación`='" + ub.getId() + "',`estado`='" + state + "' WHERE idproducto=" + temp + " and cia=" + ControlSoftware.cia);
    ...
    private void marcaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_marcaMouseClicked
        ...
        descmarca.setText("" + bd.valor("select marca from marca where idmarca=" + marca.getText()));
        descat.setText("" + bd.valor("select categoria from categoria where codcategoria=" + codcat.getText()));
        dessub.setText("" + bd.valor("select subcategoria from subcategoria where codsubcategoria=" + codsub.getText() + " and idcategoria=" + codcat.getText()));
        desprov.setText("" + bd.valor("select proveedor from proveedor where idproveedor=" + codprov.getText()));
    ...
    private void u1KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_u1KeyTyped
        // TODO add your handling code here:
        int key = evt.getKeyChar();
        if (!(key == '0' || key == '1' || key == '2' || key == '3' || key == '4' || key == '5' || key == '6' || key == '7' || key == '8' || key == '9' || key == '.') || (key == '.' && u1.getText().contains("."))) {
            evt.consume();
        }
    ...
    private void u2KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_u2KeyTyped
        // TODO add your handling code here:
        int key = evt.getKeyChar();
        if (!(key == '0' || key == '1' || key == '2' || key == '3' || key == '4' || key == '5' || key == '6' || key == '7' || key == '8' || key == '9' || key == '.') || (key == '.' && u2.getText().contains("."))) {
            evt.consume();
        }
    ...
    private void u3KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_u3KeyTyped
        // TODO add your handling code here:
        int key = evt.getKeyChar();
        if (!(key == '0' || key == '1' || key == '2' || key == '3' || key == '4' || key == '5' || key == '6' || key == '7' || key == '8' || key == '9' || key == '.') || (key == '.' && u3.getText().contains("."))) {
            evt.consume();
        }
    ...
    private void u4KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_u4KeyTyped
        // TODO add your handling code here:
        int key = evt.getKeyChar();
        if (!(key == '0' || key == '1' || key == '2' || key == '3' || key == '4' || key == '5' || key == '6' || key == '7' || key == '8' || key == '9' || key == '.') || (key == '.' && u4.getText().contains("."))) {
            evt.consume();
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new modificarproducto(40, 1).setVisible(true);
            }
        });
    }
