...
public class seleccionar_productouoc extends javax.swing.JInternalFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!codigo.getText().equals("") && descripcion.getText().equals("")) {
            bd.LlenarTabla("select * from producto where codigo like '%" + codigo.getText() + "%'", Productos);
        } else if (codigo.getText().equals("") && !descripcion.getText().equals("")) {
            bd.LlenarTabla("select * from producto where descripcion like '%" + descripcion.getText() + "%'", Productos);
        } else if (codigo.getText().equals("") && descripcion.getText().equals("")) {
            bd.LlenarTabla("select * from producto", Productos);
        }
