    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (jCheckBox1.isSelected()) {
            if (!codigo.getText().isEmpty() && descripcion.getText().isEmpty()) {
                bd.LlenarTabla("select * from producto where existencia>0 and codigo like '%" + codigo.getText() + "%'" + "and cia=" + ControlSoftware.cia , Productos);
            } else if (codigo.getText().isEmpty() && !descripcion.getText().isEmpty()) {
                bd.LlenarTabla("select * from producto where existencia>0 and descripcion like '%" + descripcion.getText() + "%'" + "and cia=" + ControlSoftware.cia , Productos);
            } else if (codigo.getText().isEmpty() && descripcion.getText().isEmpty()) {
                bd.LlenarTabla("select * from producto where existencia>0 and cia=" + ControlSoftware.cia, Productos);
            }
        } else {
            if (!codigo.getText().isEmpty() && descripcion.getText().isEmpty()) {
