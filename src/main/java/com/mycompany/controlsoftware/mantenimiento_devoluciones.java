 ...
 */
public class mantenimiento_devoluciones extends javax.swing.JInternalFrame {
    ...
    public mantenimiento_devoluciones() {
...
//        jButton5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/back72.png")));
    ...
    private void initComponents() {
        ...
        jLabel10.setText("MANTENIMIENTO DE DEVOLUCIONES");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            if (ninguno.isSelected()) {
                bd.LlenarTabla("select devolucion.id_devolucion as COD, devolucion.n_devolucion as NDEVOLUCION, factura.numerofactura AS NFACTURA, CASE factura.tipo WHEN '1' THEN 'ORIGINAL' WHEN '0' THEN 'CP' END as TIPOFACTURA, cliente.Nombre as CLIENTE, devolucion.subtotal as SUBTOTAL, devolucion.isv as ISV, devolucion.total as TOTAL, devolucion.fecha_devolucion as FECHA_DEVOLUCION, devolucion.fecha_sistema as FECHA_SISTEMA, usuario.user as USUARIO_DEVUELVE, devolucion.observacion as OBS, CASE devolucion.estado WHEN '0' THEN 'ANULADA' WHEN '1' THEN 'INGRESADA' END AS ESTADO FROM devoluciones devolucion inner join factura factura on devolucion.id_factura=factura.idfactura inner join clientes cliente on cliente.idcliente=factura.idcliente inner join usuario usuario on usuario.cod_user=devolucion.idusuario where devolucion.cia=" + ControlSoftware.cia, Productos);
            } else if (pnumero.isSelected() && !dnumero.getText().isEmpty() && !hnumero.getText().isEmpty()) {
                bd.LlenarTabla("select devolucion.id_devolucion as COD, devolucion.n_devolucion as NDEVOLUCION, factura.numerofactura AS NFACTURA, CASE factura.tipo WHEN '1' THEN 'ORIGINAL' WHEN '0' THEN 'CP' END as TIPOFACTURA, cliente.Nombre as CLIENTE, devolucion.subtotal as SUBTOTAL, devolucion.isv as ISV, devolucion.total as TOTAL, devolucion.fecha_devolucion as FECHA_DEVOLUCION, devolucion.fecha_sistema as FECHA_SISTEMA, usuario.user as USUARIO_DEVUELVE, devolucion.observacion as OBS, CASE devolucion.estado WHEN '0' THEN 'ANULADA' WHEN '1' THEN 'INGRESADA' END AS ESTADO FROM devoluciones devolucion inner join factura factura on devolucion.id_factura=factura.idfactura inner join clientes cliente on cliente.idcliente=factura.idcliente inner join usuario usuario on usuario.cod_user=devolucion.idusuario where devolucion.cia=" + ControlSoftware.cia + " and devolucion.n_devolucion between " + dnumero.getText() + " and " + hnumero.getText(), Productos);
                ...
                if (date2.compareTo(date1) == -1) {
                    ...
                    bd.LlenarTabla("select devolucion.id_devolucion as COD, devolucion.n_devolucion as NDEVOLUCION, factura.numerofactura AS NFACTURA, CASE factura.tipo WHEN '1' THEN 'ORIGINAL' WHEN '0' THEN 'CP' END as TIPOFACTURA, cliente.Nombre as CLIENTE, devolucion.subtotal as SUBTOTAL, devolucion.isv as ISV, devolucion.total as TOTAL, devolucion.fecha_devolucion as FECHA_DEVOLUCION, devolucion.fecha_sistema as FECHA_SISTEMA, usuario.user as USUARIO_DEVUELVE, devolucion.observacion as OBS, CASE devolucion.estado WHEN '0' THEN 'ANULADA' WHEN '1' THEN 'INGRESADA' END AS ESTADO FROM devoluciones devolucion inner join factura factura on devolucion.id_factura=factura.idfactura inner join clientes cliente on cliente.idcliente=factura.idcliente inner join usuario usuario on usuario.cod_user=devolucion.idusuario where devolucion.cia=" + ControlSoftware.cia + " and devolucion.fecha_sistema between '" + Date_Format.format(dfecha.getDate()) + "' and '" + Date_Format.format(hfecha.getDate()) + "'", Productos);
                }
            } else if (pcliente.isSelected() && !cliente.getText().isEmpty()) {
                bd.LlenarTabla("select devolucion.id_devolucion as COD, devolucion.n_devolucion as NDEVOLUCION, factura.numerofactura AS NFACTURA, CASE factura.tipo WHEN '1' THEN 'ORIGINAL' WHEN '0' THEN 'CP' END as TIPOFACTURA, cliente.Nombre as CLIENTE, devolucion.subtotal as SUBTOTAL, devolucion.isv as ISV, devolucion.total as TOTAL, devolucion.fecha_devolucion as FECHA_DEVOLUCION, devolucion.fecha_sistema as FECHA_SISTEMA, usuario.user as USUARIO_DEVUELVE, devolucion.observacion as OBS, CASE devolucion.estado WHEN '0' THEN 'ANULADA' WHEN '1' THEN 'INGRESADA' END AS ESTADO FROM devoluciones devolucion inner join factura factura on devolucion.id_factura=factura.idfactura inner join clientes cliente on cliente.idcliente=factura.idcliente inner join usuario usuario on usuario.cod_user=devolucion.idusuario where devolucion.cia=" + ControlSoftware.cia + " and c.nombre like '%" + cliente.getText() + "%'", Productos);
                ...
                if (date2.compareTo(date1) == -1) {
                    ...
                    bd.LlenarTabla("select devolucion.id_devolucion as COD, devolucion.n_devolucion as NDEVOLUCION, factura.numerofactura AS NFACTURA, CASE factura.tipo WHEN '1' THEN 'ORIGINAL' WHEN '0' THEN 'CP' END as TIPOFACTURA, cliente.Nombre as CLIENTE, devolucion.subtotal as SUBTOTAL, devolucion.isv as ISV, devolucion.total as TOTAL, devolucion.fecha_devolucion as FECHA_DEVOLUCION, devolucion.fecha_sistema as FECHA_SISTEMA, usuario.user as USUARIO_DEVUELVE, devolucion.observacion as OBS, CASE devolucion.estado WHEN '0' THEN 'ANULADA' WHEN '1' THEN 'INGRESADA' END AS ESTADO FROM devoluciones devolucion inner join factura factura on devolucion.id_factura=factura.idfactura inner join clientes cliente on cliente.idcliente=factura.idcliente inner join usuario usuario on usuario.cod_user=devolucion.idusuario where devolucion.cia=" + ControlSoftware.cia + " and c.nombre like '%" + cliente.getText() + "%'" + " and devolucion.fecha_sistema between '" + Date_Format.format(dfecha.getDate()) + "' and '" + Date_Format.format(hfecha.getDate()) + "'" + " and devolucion.n_devolucion between " + dnumero.getText() + " and " + hnumero.getText(), Productos);
                }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        ingresar_devolucion l = new ingresar_devolucion();
        ...
        try {
            if (!Productos.getValueAt(Productos.getSelectedRow(), 12).toString().equals("INGRESADA")) {
                ...
                if (x == 0) {
                    ...
                    bd.EjecutarConsultas("update clientes set saldo=saldo+" + montodev + " where idcliente=" + id_cliente + " and cia=" + ControlSoftware.cia);
...
//                
                    bd.EjecutarConsultas("update factura set saldo=saldo+" + montodev + " where idfactura=" + id_factura + " and cia=" + ControlSoftware.cia);
                    ...
                    if (total_factura1 == saldo_factura1) {
                        bd.EjecutarConsultas("update factura set estado=1 where idfactura=" + id_factura + " and cia=" + ControlSoftware.cia);

                    }
                    if (total_factura1 != saldo_factura1 && saldo_factura1 != 0.00) {
                        bd.EjecutarConsultas("update factura set estado=2 where idfactura=" + id_factura + " and cia=" + ControlSoftware.cia);

                    }
                    if (saldo_factura1 == 0.00) {
                        bd.EjecutarConsultas("update factura set estado=3 where idfactura=" + id_factura + " and cia=" + ControlSoftware.cia);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mantenimiento_devoluciones.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new mantenimiento_devoluciones().setVisible(true);
            }
        });
    }
