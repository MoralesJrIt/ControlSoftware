 ...
 * @author Usuario
 */
public class seleccionar_producto3 extends javax.swing.JInternalFrame {
...
//        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/back72.png")));
    ...
    private void initComponents() {
        ...
        jLabel10.setText("SELECCIONAR PRODUCTO-PEDIDO");
    ...
    private void ProductosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ProductosMouseClicked
        ...
        if (evt.getClickCount() == 2 && !evt.isConsumed()) {
            evt.consume();
            if (Integer.parseInt(bd.valor("select existencia from producto where cia="+ControlSoftware.cia+" and idproducto=" + Productos.getValueAt(pick, 0)))-Integer.parseInt(bd.valor("select reserva from producto where cia="+ControlSoftware.cia+" and idproducto=" + Productos.getValueAt(pick, 0))) == 0) {
                JOptionPane.showMessageDialog(null, "No se puede agregar este producto debido a que no hay existencia");
                return;
            }
            for (int i = 0; i < modificar_orden_de_pedido.detalle.getRowCount(); i++) {
                if (modificar_orden_de_pedido.detalle.getValueAt(i, 0).toString().equals(Productos.getValueAt(pick, 0).toString())) {
                    JOptionPane.showMessageDialog(null, "PRODUCTO YA AGREGADO, SELECCIONE OTRO");
                    return;
                }
            }
            modificar_orden_de_pedido.idprod.setText("" + Productos.getValueAt(pick, 0));
            modificar_orden_de_pedido.codprod.setText("" + Productos.getValueAt(pick, 1));
            modificar_orden_de_pedido.desprod.setText("" + Productos.getValueAt(pick, 2));
            ...
            modificar_orden_de_pedido.costo.setText("" + costoenletras);
            modificar_orden_de_pedido.p1.setText(Productos.getValueAt(pick, 14).toString());
            modificar_orden_de_pedido.p2.setText(Productos.getValueAt(pick, 16).toString());
            modificar_orden_de_pedido.p3.setText(Productos.getValueAt(pick, 18).toString());
            modificar_orden_de_pedido.existencia.setText(""+(Integer.parseInt(Productos.getValueAt(pick, 5).toString())-Integer.parseInt(Productos.getValueAt(pick, 6).toString())));
            modificar_orden_de_pedido.costonumeros = Productos.getValueAt(pick, 8).toString();
            modificar_orden_de_pedido.pventa.setText(Productos.getValueAt(pick, 14).toString());
            dispose();
            modificar_orden_de_pedido.cantidad.requestFocus();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(seleccionar_producto3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new seleccionar_producto3().setVisible(true);
            }
        });
    }
