 ...
 * @author Usuario
 */
public class seleccionar_categoria4 extends javax.swing.JInternalFrame {

    /**
     * Creates new form seleccionar_categoria
     */BaseDeDatos bd = new BaseDeDatos();
     String s="";
    public seleccionar_categoria4(String selec) {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 2 && !evt.isConsumed()) {
            ...
            if(s.equals("1")){
            catalogogeneraldeproductos_opciones.codcat.setText(cod.getText());
            catalogogeneraldeproductos_opciones.descat.setText(descripcion.getText());
            dispose();
            }
             if(s.equals("2")){
            catalogogeneraldeproductos_opciones.codcat1.setText(cod.getText());
            catalogogeneraldeproductos_opciones.descat1.setText(descripcion.getText());
            dispose();
            }
              if(s.equals("3")){
            comprobarinventario_opciones.codcat1.setText(cod.getText());
            comprobarinventario_opciones.descat1.setText(descripcion.getText());
            dispose();
            }
               if(s.equals("4")){
            comprobarinventario_opciones.codcat1.setText(cod.getText());
            ...
            dispose();
               ...
               if(s.equals("5")){
            catalogodeprecios_opciones.codcat1.setText(cod.getText());
            catalogodeprecios_opciones.descat1.setText(descripcion.getText());
            dispose();
            }
               if(s.equals("6")){
            catalogodeprecios_opciones.codcat1.setText(cod.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(seleccionar_categoria4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new seleccionar_categoria4("0").setVisible(true);
            }
        });
    }
