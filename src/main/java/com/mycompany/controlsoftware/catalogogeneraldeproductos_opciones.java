 ...
 * @author Usuario
 */
public class catalogogeneraldeproductos_opciones extends javax.swing.JInternalFrame {
    ...
    public catalogogeneraldeproductos_opciones() {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("TIPO DE CATÁLOGO");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (con.isSelected() && !porgrupo.isSelected() && !porgrupoysubgrupo.isSelected()) {
            try {
                ...
                String path = "/catalogoproductos.jasper";
        ...
        if (sin.isSelected() && !porgrupo.isSelected() && !porgrupoysubgrupo.isSelected()) {
            try {
                ...
                Connection conn = con.getConexion();
                // Cargar el reporte desde el archivo .jasper
                String path = "/catalogoproductos_soloexistencias.jasper";
                InputStream inputStream = getClass().getResourceAsStream(path);
                JasperReport jasperReport = (JasperReport) JRLoader.loadObject(inputStream);
        ...
        if (con.isSelected() && porgrupo.isSelected() && !porgrupoysubgrupo.isSelected()) {
            ...
            try {
                ...
                Connection conn = con.getConexion();
                // Cargar el reporte desde el archivo .jasper
                String path = "/catalogoproductos_porgrupo.jasper";
                InputStream inputStream = getClass().getResourceAsStream(path);
                JasperReport jasperReport = (JasperReport) JRLoader.loadObject(inputStream);
        ...
        if (sin.isSelected() && porgrupo.isSelected() && !porgrupoysubgrupo.isSelected()) {
            ...
            try {
                ...
                Connection conn = con.getConexion();
                // Cargar el reporte desde el archivo .jasper
                String path = "/catalogoproductos_porgrupo_soloexistencias.jasper";
                InputStream inputStream = getClass().getResourceAsStream(path);
                JasperReport jasperReport = (JasperReport) JRLoader.loadObject(inputStream);
        ...
        if (con.isSelected() && porgrupo.isSelected() && porgrupoysubgrupo.isSelected()) {
            ...
            try {
                ...
                Connection conn = con.getConexion();
                // Cargar el reporte desde el archivo .jasper
                String path = "/catalogoproductos_porgrupoysubgrupo.jasper";
                InputStream inputStream = getClass().getResourceAsStream(path);
                JasperReport jasperReport = (JasperReport) JRLoader.loadObject(inputStream);
        ...
        if (sin.isSelected() && porgrupo.isSelected() && porgrupoysubgrupo.isSelected()) {
            ...
            try {
                ...
                Connection conn = con.getConexion();
                // Cargar el reporte desde el archivo .jasper
                String path = "/catalogoproductos_porgrupoysubgrupo_soloexistencias.jasper";
                InputStream inputStream = getClass().getResourceAsStream(path);
                JasperReport jasperReport = (JasperReport) JRLoader.loadObject(inputStream);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        seleccionar_categoria4 l = new seleccionar_categoria4("1");
        Dimension internalFrameSize = l.getSize();
        Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
        l.setLocation((screenSize.width - internalFrameSize.width) / 2,
                (screenSize.height - internalFrameSize.height) / 2);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        seleccionar_subcategoria2 l = new seleccionar_subcategoria2("1", codcat.getText());
        Dimension internalFrameSize = l.getSize();
        Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
        l.setLocation((screenSize.width - internalFrameSize.width) / 2,
                (screenSize.height - internalFrameSize.height) / 2);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
        seleccionar_categoria4 l = new seleccionar_categoria4("2");
        Dimension internalFrameSize = l.getSize();
        Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
        l.setLocation((screenSize.width - internalFrameSize.width) / 2,
                (screenSize.height - internalFrameSize.height) / 2);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
        seleccionar_subcategoria2 l = new seleccionar_subcategoria2("2", codcat1.getText());
        Dimension internalFrameSize = l.getSize();
        Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
        l.setLocation((screenSize.width - internalFrameSize.width) / 2,
                (screenSize.height - internalFrameSize.height) / 2);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(catalogogeneraldeproductos_opciones.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new catalogogeneraldeproductos_opciones().setVisible(true);
            }
        });
    }
