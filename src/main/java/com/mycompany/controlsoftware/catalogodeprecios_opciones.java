 ...
 * @author Usuario
 */
public class catalogodeprecios_opciones extends javax.swing.JInternalFrame {
    ...
    public catalogodeprecios_opciones() {
    ...
    private void initComponents() {
        ...
        mcosto = new javax.swing.JCheckBox();
        ...
        mexistencia = new javax.swing.JCheckBox();
        ...
        jLabel3.setText("TIPO DE FORMATO PRECIOS");
        ...
        mcosto.setBackground(new java.awt.Color(255, 255, 255));
        mcosto.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        mcosto.setForeground(new java.awt.Color(0, 0, 0));
        mcosto.setText("MOSTRAR COSTO");
        ...
        buttonGroup2.add(n2);
        n2.setFont(new java.awt.Font("SansSerif", 1, 12)); // NOI18N
        n2.setForeground(new java.awt.Color(0, 0, 0));
        n2.setText("HASTA NIVEL 2");

        n1.setBackground(new java.awt.Color(255, 255, 255));
        buttonGroup2.add(n1);
        n1.setFont(new java.awt.Font("SansSerif", 1, 12)); // NOI18N
        n1.setForeground(new java.awt.Color(0, 0, 0));
        n1.setSelected(true);
        n1.setText("HASTA NIVEL 1");
        ...
        buttonGroup2.add(n4);
        n4.setFont(new java.awt.Font("SansSerif", 1, 12)); // NOI18N
        n4.setForeground(new java.awt.Color(0, 0, 0));
        n4.setText("HASTA NIVEL 4");

        n3.setBackground(new java.awt.Color(255, 255, 255));
        buttonGroup2.add(n3);
        n3.setFont(new java.awt.Font("SansSerif", 1, 12)); // NOI18N
        n3.setForeground(new java.awt.Color(0, 0, 0));
        n3.setText("HASTA NIVEL 3");

        n5.setBackground(new java.awt.Color(255, 255, 255));
        buttonGroup2.add(n5);
        n5.setFont(new java.awt.Font("SansSerif", 1, 12)); // NOI18N
        n5.setForeground(new java.awt.Color(0, 0, 0));
        n5.setText("HASTA NIVEL 5");

        mexistencia.setBackground(new java.awt.Color(255, 255, 255));
        mexistencia.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        mexistencia.setForeground(new java.awt.Color(0, 0, 0));
        mexistencia.setText("MOSTRAR EXISTENCIA");
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel3, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 644, Short.MAX_VALUE)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(con)
                            .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addGroup(jPanel4Layout.createSequentialGroup()
                                    ...
                                    .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addComponent(dessub)
                                        .addComponent(descat, javax.swing.GroupLayout.PREFERRED_SIZE, 221, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (con.isSelected() && !porgrupo.isSelected() && !porgrupoysubgrupo.isSelected()) {
            try {
                BaseDeDatos con = new BaseDeDatos();
                Connection conn = con.getConexion();
                // Cargar el reporte desde el archivo .jasper
                String path = "/catalogoprecios.jasper";
                ...
                parametros.put("mostrarcosto", cst);
                parametros.put("nivel", lvl);
                parametros.put("mostrarexistencia", exs);
        ...
        if (sin.isSelected() && !porgrupo.isSelected() && !porgrupoysubgrupo.isSelected()) {
            try {
                BaseDeDatos con = new BaseDeDatos();
                Connection conn = con.getConexion();
                // Cargar el reporte desde el archivo .jasper
                String path = "/catalogoprecios_soloexistencias.jasper";
                InputStream inputStream = getClass().getResourceAsStream(path);
                JasperReport jasperReport = (JasperReport) JRLoader.loadObject(inputStream);
        ...
        if (con.isSelected() && porgrupo.isSelected() && !porgrupoysubgrupo.isSelected()) {
            ...
            try {
                ...
                Connection conn = con.getConexion();
                // Cargar el reporte desde el archivo .jasper
                String path = "/catalogoprecios_porgrupo.jasper";
                InputStream inputStream = getClass().getResourceAsStream(path);
                JasperReport jasperReport = (JasperReport) JRLoader.loadObject(inputStream);
        ...
        if (sin.isSelected() && porgrupo.isSelected() && !porgrupoysubgrupo.isSelected()) {
            ...
            try {
                ...
                Connection conn = con.getConexion();
                // Cargar el reporte desde el archivo .jasper
                String path = "/catalogoprecios_porgrupo_soloexistencias.jasper";
                InputStream inputStream = getClass().getResourceAsStream(path);
                JasperReport jasperReport = (JasperReport) JRLoader.loadObject(inputStream);
        ...
        if (con.isSelected() && porgrupo.isSelected() && porgrupoysubgrupo.isSelected()) {
            ...
            try {
                ...
                Connection conn = con.getConexion();
                // Cargar el reporte desde el archivo .jasper
                String path = "/catalogoprecios_porgrupoysubgrupo.jasper";
                InputStream inputStream = getClass().getResourceAsStream(path);
                JasperReport jasperReport = (JasperReport) JRLoader.loadObject(inputStream);
        ...
        if (sin.isSelected() && porgrupo.isSelected() && porgrupoysubgrupo.isSelected()) {
            ...
            try {
                ...
                Connection conn = con.getConexion();
                // Cargar el reporte desde el archivo .jasper
                String path = "/catalogoprecios_porgrupoysubgrupo_soloexistencias.jasper";
                InputStream inputStream = getClass().getResourceAsStream(path);
                JasperReport jasperReport = (JasperReport) JRLoader.loadObject(inputStream);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
        seleccionar_subcategoria2 l = new seleccionar_subcategoria2("6", codcat1.getText());
        Dimension internalFrameSize = l.getSize();
        Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
        l.setLocation((screenSize.width - internalFrameSize.width) / 2,
                (screenSize.height - internalFrameSize.height) / 2);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        seleccionar_categoria4 l = new seleccionar_categoria4("5");
        Dimension internalFrameSize = l.getSize();
        Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
        l.setLocation((screenSize.width - internalFrameSize.width) / 2,
                (screenSize.height - internalFrameSize.height) / 2);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        seleccionar_subcategoria2 l = new seleccionar_subcategoria2("5", codcat.getText());
        Dimension internalFrameSize = l.getSize();
        Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
        l.setLocation((screenSize.width - internalFrameSize.width) / 2,
                (screenSize.height - internalFrameSize.height) / 2);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
        seleccionar_categoria4 l = new seleccionar_categoria4("6");
        Dimension internalFrameSize = l.getSize();
        Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
        l.setLocation((screenSize.width - internalFrameSize.width) / 2,
                (screenSize.height - internalFrameSize.height) / 2);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(catalogodeprecios_opciones.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new catalogodeprecios_opciones().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JCheckBox mcosto;
    private javax.swing.JCheckBox mexistencia;
