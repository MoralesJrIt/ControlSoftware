 ...
 * @author Usuario
 */
public class seleccionar_producto2 extends javax.swing.JInternalFrame {
...
//        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/back72.png")));
    ...
    private void ProductosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ProductosMouseClicked
        ...
        if (evt.getClickCount() == 2 && !evt.isConsumed()) {
            ...
            for (int i = 0; i < ingresar_orden_de_pedido.detalle.getRowCount(); i++) {
                if (ingresar_orden_de_pedido.detalle.getValueAt(i, 0).toString().equals(Productos.getValueAt(pick, 0).toString())) {
                    JOptionPane.showMessageDialog(null, "PRODUCTO YA AGREGADO, SELECCIONE OTRO");
                    return;
                }
            }
            ingresar_orden_de_pedido.idprod.setText("" + Productos.getValueAt(pick, 0));
            ingresar_orden_de_pedido.codprod.setText("" + Productos.getValueAt(pick, 1));
            ingresar_orden_de_pedido.desprod.setText("" + Productos.getValueAt(pick, 2));
            ...
            ingresar_orden_de_pedido.costo.setText("" + costoenletras);
            ingresar_orden_de_pedido.p1.setText(Productos.getValueAt(pick, 14).toString());
            ingresar_orden_de_pedido.p2.setText(Productos.getValueAt(pick, 16).toString());
            ingresar_orden_de_pedido.p3.setText(Productos.getValueAt(pick, 18).toString());
            ingresar_orden_de_pedido.existencia.setText(""+(Integer.parseInt(Productos.getValueAt(pick, 5).toString())-Integer.parseInt(Productos.getValueAt(pick, 6).toString())));
            ingresar_orden_de_pedido.costonumeros = Productos.getValueAt(pick, 8).toString();
            ingresar_orden_de_pedido.pventa.setText(Productos.getValueAt(pick, 14).toString());
            dispose();
            ingresar_orden_de_pedido.cantidad.requestFocus();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(seleccionar_producto2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new seleccionar_producto2().setVisible(true);
            }
        });
    }
